...
%   \large Campinas - SP - Brazil
  ...
  \section{Professional Experience}
    \begin{itemize}
      \item
        \textbf{Crowdstrike / Iperlane} - since October/2016
        
        Development of software container for Android, capable of running and monitoring 3rd party apps.
  ...
  \section{Education}
    \begin{itemize}
      \item
        \textbf{Specialization in Automation and Control of Industrial and Agro-Industrial Processes} - Feagri/Unicamp - desde Março/2019.
...
%         Grade Point Average: 8.8  (0-10)
  ...
  \section{A few Projects}
    \begin{itemize}
      ...
      \item 
        \textbf{Android-Full-Framework} - Gradle plugin for Android projects that expose every method/field from every Android Framework version as `public` at compile-time and then modifies the bytecode with the necessary boilerplate to access it. Very handy for hacking Android's internals.
    
      \item 
        \textbf{MongoFS} and \textbf{SpotifyFS}- FUSE filesystem to manage documents in Mongo databases as JSON files and play Spotify songs as MP3 files.
